        ...
        <div class="employee">
            <div class="s-top">
                ...
                <div class = "s-search-block">
                    ...
                    <img src="img/search-plus.svg" alt="" class = "search-icon-input">
                </div>
                                                    ...
                                                    <div class="s-center width-2">
                                                        <div class="s-center-wrap">
                                                            ...
                                                            <div class="department-section">
                                                                ...
                                                                <div class="s-cards">
                                                                    <div class="employee-card employee-card-rop" data-category = "1">
                                                            ...
                                                            <div class="department-section">
                                                                ...
                                                                <div class="s-cards">
                                                                    <div class="employee-card" data-category = "2">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
                                                                    ...
                                                                    <div class="employee-card employee-card-active" data-category = "3">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
                                                                    ...
                                                                    <div class="employee-card" data-category = "3">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
                                                                    ...
                                                                    <div class="employee-card" data-category = "4">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
                                                            ...
                                                            <div class="department-section">
                                                                ...
                                                                <div class="s-cards">
                                                                    ...
                                                                    <div class="employee-card" data-category = "5">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
                                                                    ...
                                                                    <div class="employee-card" data-category = "6">
                                                                        <div class="manager-pic" style = "background-image: url('img/m.jpg');">
                                                                            <div class="manager-pic-info">РОП</div>
                                                                        </div>
                                                                        <div class="manager-info">
